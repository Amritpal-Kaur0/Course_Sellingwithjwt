...
* I have introduced the signgin endpoints for both users and admins.
* Middleware to check the authentication/(verification of user/admin)
For this project, in every authenticated requests, you need to send the jwt in headers (Authorization : "Bearer <actual token>").
...
## Contribution
 Feel free to conntribute in this project .
